...
namespace Cargo.Infrastructure.Data.Migrations
{
    ...
    [Migration("20220421162914_AddRoutingTbl")]
    partial class AddRoutingTbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cargo.Infrastructure.Data.Model.CommPayloadRule4Flight", b =>
                {
                    b.Property<int>("CommPayloadRuleId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CommPayloadRules4Flight");
                });
            ...
            modelBuilder.Entity("Cargo.Infrastructure.Data.Model.Routing", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint unsigned");
            ...
            modelBuilder.Entity("Cargo.Infrastructure.Data.Model.Booking", b =>
                {
                    ...
                    b.HasOne("Cargo.Infrastructure.Data.Model.Schedule.FlightShedule", "Flight")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("Cargo.Infrastructure.Data.Model.CommPayloadRule4Flight", b =>
                {
                    b.HasOne("Cargo.Infrastructure.Data.Model.CommercialPayload", "CommercialPayload")
                        .WithOne()
                        .HasForeignKey("Cargo.Infrastructure.Data.Model.CommPayloadRule4Flight", "CommPayloadRuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cargo.Infrastructure.Data.Model.Schedule.FlightShedule", "FlightSchedule")
                        .WithOne()
                        .HasForeignKey("Cargo.Infrastructure.Data.Model.CommPayloadRule4Flight", "FlightScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Cargo.Infrastructure.Data.Model.Routing", b =>
                {
                    b.HasOne("Cargo.Infrastructure.Data.Model.Booking", "Booking")
                        .WithMany("Routings")
